...
public class sidrolandia extends JFrame {
    ...
    public sidrolandia() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/icones/pin-de-localizacao.png"));
    ...
    private void initComponents() {
        setTitle("Estoque em Sidrolãndia"); // Define o título da janela
 ...
 private void editarProduto() {
   ...
   // leitura de dados locais 
    private void loadData() {
        try {
            FileReader fileReader = new FileReader("dados4.txt");
    ...
    private void saveData() {
        try {
            FileWriter fileWriter = new FileWriter("dados4.txt");
    ...
    if (option == JFileChooser.APPROVE_OPTION) {
        ...
        try {
            if (fileExtension.equals("pdf")) {
                ...
                document.add(new Paragraph("--    Relatório de Estoque Em Sidrolândia MS   --"));
                document.add(new Paragraph("-------------------------------------------------------------"));
                ...
                writer.write("------------------------------------------------------------\n");
                writer.write("--    Relatório de Estoque Em Sidrolãndia MS   --\n");
                writer.write("-------------------------------------------------------------\n");
