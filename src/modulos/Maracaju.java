...
public class Maracaju extends JFrame {
    ...
    public Maracaju() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/icones/salsicha.png"));
    ...
    private void initComponents() {
        setTitle("Estoque em Maracaju"); // Define o título da janela
...
private void novoProduto() {
 ...
 private void editarProduto() {
    ...
    private void loadData() {
        try {
            FileReader fileReader = new FileReader("dados3.txt");
    ...
    private void saveData() {
        try {
            FileWriter fileWriter = new FileWriter("dados3.txt");
    ...
    if (option == JFileChooser.APPROVE_OPTION) {
        ...
        try {
            if (fileExtension.equals("pdf")) {
                ...
                document.add(new Paragraph("--    Relatório de Estoque Em Maracaju MS   --"));
                document.add(new Paragraph("-------------------------------------------------------------"));
                ...
                writer.write("------------------------------------------------------------\n");
                writer.write("--    Relatório de Estoque Em MAracaju MS   --\n");
                writer.write("-------------------------------------------------------------\n");
