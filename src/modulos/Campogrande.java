...
public class Campogrande extends JFrame {
    ...
    public Campogrande() {
        ...
        ImageIcon icon = new ImageIcon(getClass().getResource("/icones/cidade2.png"));
    ...
    private void initComponents() {
        setTitle("Estoque em Campo Grande"); // Define o título da janela
...
private void novoProduto() {
 ...
 private void editarProduto() {
    ...
    private void loadData() {
        try {
            FileReader fileReader = new FileReader("dados5.txt");
    ...
    private void saveData() {
        try {
            FileWriter fileWriter = new FileWriter("dados5.txt");
    ...
    if (option == JFileChooser.APPROVE_OPTION) {
        ...
        try {
            if (fileExtension.equals("pdf")) {
                ...
                document.add(new Paragraph("--    Relatório de Estoque Em Campo Grande MS   --"));
                document.add(new Paragraph("-------------------------------------------------------------"));
                ...
                writer.write("------------------------------------------------------------\n");
                writer.write("--    Relatório de Estoque Em Campo Grande MS   --\n");
                writer.write("-------------------------------------------------------------\n");
