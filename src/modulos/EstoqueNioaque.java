...
public class EstoqueNioaque extends JFrame {

    private JTable table;
    private DefaultTableModel tableModel;
    private List<Produto> produtos;

    public EstoqueNioaque() {

        // Define o ícone da janela
        ImageIcon icon = new ImageIcon(getClass().getResource("/icones/dinosaur.png"));
    ...
    private void initComponents() {
        setTitle("Estoque em Nioaque"); // Define o título da janela
    ...
    if (option == JFileChooser.APPROVE_OPTION) {
        ...
        try {
            if (fileExtension.equals("pdf")) {
                ...
                document.add(new Paragraph("--    Relatório de Estoque Em Nioaque MS   --"));
                document.add(new Paragraph("-------------------------------------------------------------"));
                ...
                writer.write("------------------------------------------------------------\n");
                writer.write("--    Relatório de Estoque Em Nioaque MS   --\n");
                writer.write("-------------------------------------------------------------\n");
